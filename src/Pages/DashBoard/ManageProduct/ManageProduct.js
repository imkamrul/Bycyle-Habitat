    ...
    <div>
      <Container className="py-5">
        ...
        <Row className="heading g-0 py-3 mx-5">
          <Col md={3} xs={6}>
            <h3 className="mb-0 fs-5 text-start ps-3">Name</h3>
          </Col>
          <Col md={1} xs={6}>
            <h3 className="mb-0 fs-5">Image</h3>
          </Col>
          <Col md={2} xs={6}>
            <h3 className="mb-0 fs-5">Price</h3>
          </Col>
          <Col md={3} xs={6}>
            <h3 className="mb-0 fs-5">Description</h3>
          </Col>
          <Col md={1} xs={6}>
            <h3 className="mb-0 text-center fs-5">Update</h3>
          </Col>
          <Col md={2} xs={6}>
        ...
        {allProducts.length ? (
          allProducts.map((product) => (
            <Row key={product._id} className="user-order-detail g-0 mx-5">
              <Col md={3} xs={12}>
              ...
              <Col md={2} xs={6}>
                <h5 className="mb-0 mt-2 fs-6 ">{product.price} Tk</h5>
              </Col>
              <Col md={3} xs={6}>
                <h5 className="mb-0 mt-2 fs-6 ">
      ...
      <Modal
        ...
        onHide={handleupdatingMOdalClose}
        backdrop="static"
        keyboard={false}
      >
        ...
        <Modal.Body>
          <Form onSubmit={handleUpdateSubmit}>
            ...
            <p className="text-center my-3">
              {" "}
              <Button type="submit" variant="danger" className="banner-btn">
                {" "}
                Update Product
              </Button>
            </p>
